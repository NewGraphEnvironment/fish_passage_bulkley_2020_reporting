...
```{r fish-wct-fiss-summary, eval=T}
...
```{r fish-plot-grad, out.width = photo_width, fig.cap= 'Summary of select historic salmonid observations vs. stream gradient category.', eval=T}
##bar graph
...
```{r fish-plot-width, out.width = photo_width, fig.cap= 'Summary of select historic salmonid observations vs. channel width category.', eval=T}
##bar graph
...
```{r fish-plot-wshed, out.width = photo_width, fig.cap= 'Summary of select historic salmonid observations vs. watershed size category.', eval=T}
##bar graph
