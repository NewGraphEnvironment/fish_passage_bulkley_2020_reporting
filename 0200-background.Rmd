...
```{r hydrology-plot, fig.cap = 'Hydrograph for Elk River at Fernie (Station #08NK002). Available daily discharge data from 1970 to 2018 with black line and shaded ribbon representing mean and maximum/minimum flows respectively.', eval=FALSE}
knitr::include_graphics("fig/hydrology2.png")
```

<br>

```{r hydrology-stats, fig.cap = 'Summary of hydrology statistics in Elk River at Fernie (Station #08NK002)', eval=FALSE}
