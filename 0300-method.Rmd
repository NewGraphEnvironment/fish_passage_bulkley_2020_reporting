...
knitr::kable(tab_barrier_scoring,
             caption = 'Fish Barrier Scoring (MoE 2011).') %>% 
...
knitr::kable(tab_barrier_result,
             caption = 'Fish Barrier Scoring Results (MoE 2011).') 
