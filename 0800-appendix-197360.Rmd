...
my_caption1 = paste0('Outlet pool electrofished downstream of crossing ', my_site, ' in 2023.')
...
my_photo2 = fpr::fpr_photo_pull_by_str(site = my_site, dir_photos = "data/2023/photos/", str_to_pull = 'us_ef1_typical_2')

my_caption2 = paste0('Area electrofished ~350m upstream of crossing ', my_site, ' in 2023.')

```

```{r photo-197360-06, fig.cap= my_caption2, out.width = photo_width, eval=gitbook_on}
