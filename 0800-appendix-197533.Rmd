...
At the crossing locations, Brule Creek is a 5th order stream with a watershed area upstream of the highway of approximately 87km^2^. The elevation of the watershed ranges from a maximum of 2800 to 1200m at  PSCIS crossing `r as.character(my_site)`. Brule Creek is known to contain westslope cutthrout trout, rainbow trout and bull trout downstream of the subject culverts and westslope cutthrout trout and rainbow trout above [@data_fish_obs]. On the south side of the upper watershed, at an elevation of 2000m is Josephine Lake (A.K.A. Big Lake) which is 5ha in area. A biophysical inventory in 1983 indicated the lake contained no fish however, it was stocked with westslope cutthrout trout from 1983 - 2000 [@data_fish_obs; @FishInventoriesData2020].
