...
tab_sum_input %>% 
  ...
  kableExtra::add_footnote(label = paste0('Photos: ', 
                                          paste0('![](data/photos/', 4605732, '/crossing_all.JPG)')), notation = 'none') %>% 
