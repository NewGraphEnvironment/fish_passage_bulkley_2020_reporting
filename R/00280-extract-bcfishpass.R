...
dat2 <- import_pscis(workbook_name = 'pscis_phase2.xlsm') %>% #sites with no my_crossing_reference have a pscis id already
  filter(!is.na(pscis_crossing_id)) #sites with no my_crossing_reference have a pscis id already
