...
# str_type %>% readr::write_csv(file = paste0(getwd(), '/data/raw_input/pscis1_str_type.csv'))
# str_type %>% readr::write_csv(file = paste0(getwd(), '/data/raw_input/pscis2_str_type.csv'))
str_type %>% readr::write_csv(file = paste0(getwd(), '/data/raw_input/pscis_reassessments_str_type.csv'))
